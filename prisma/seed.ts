...
async function up() {
  await prisma.shipmentMethod.createMany({
    data: [
      {
        title: 'Free',
  ...
  await prisma.product.create({
    data: {
      ...
      colorId: 2,
      categoryId: 1,
      colors: { connect: [{ id: 1 }, { id: 2 }, { id: 4 }, { id: 7 }] },
  ...
  await prisma.product.create({
    data: {
      ...
      colorId: 9,
      categoryId: 1,
      colors: { connect: [{ id: 9 }, { id: 1 }, { id: 10 }] },
      memory: { connect: [{ id: 1 }, { id: 2 }, { id: 3 }] },
  ...
  await prisma.product.create({
    data: {
      ...
      colorId: 11,
      categoryId: 1,
      colors: { connect: [{ id: 11 }, { id: 4 }, { id: 1 }] },
      memory: { connect: [{ id: 1 }, { id: 2 }, { id: 3 }] },
      title: 'Samsung Galaxy S24 Ultra Gray',
      defaultImage:
        'https://i.allo.ua/media/catalog/product/cache/3/image/710x600/602f0fa2c1f0d1ba5e241f914e856ff9/s/m/sm-s928_galaxys24ultra_front_titaniumgray_231106_result_1.jpg',
    },
  });
  ...
  await prisma.product.create({
    data: {
      ...
      colorId: 11,
      categoryId: 1,
      colors: { connect: [{ id: 4 }, { id: 11 }, { id: 7 }] },
      memory: { connect: [{ id: 1 }, { id: 2 }] },
...
async function down() {
  ...
  await prisma.$queryRaw`TRUNCATE TABLE "shipment_method" RESTART IDENTITY CASCADE`;
}
